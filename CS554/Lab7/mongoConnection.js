    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, mongodb_1.MongoClient.connect(settings.mongoConfig.serverURL, { useNewUrlParser: true })];
            case 1:
                connection = _a.sent();
                return [4 /*yield*/, connection.db(settings.mongoConfig.database)];
            case 2:
                db = _a.sent();
                _a.label = 3;
