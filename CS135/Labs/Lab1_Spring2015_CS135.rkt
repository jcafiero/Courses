...
;Your TA will check your definition.
...
;Since these take just two arguments, our (commute? operator)
;predicate will work on them.  Try it!

;Are those answers correct?


;If hope your defintion of xor from PART 1 is correct, because your TA 
...
;That left side is "not or"--that's "nor".  Savenge code from "nand"
...
;HINT:  Your definition must include each of p, q, r.  However, 
;individual pieces of your definition may include just one or two of 
;them.
...
;Your TA will test 3majority and/or isosceles


;  GOLDEN TICKET (if->then-if->then)     

;The noise grew louder.  The din became deafening. 
;"If I got here first, then if the gates open then I get to go through 
;first!" Violet screamed.

;"What?" shouted Mike Teevee.

;"She said, "If if she got here first then the gates open, then she 
;gets to go in first.  But I want to go in first!" roared Veruca.

;August Gloop said, "It doesn't matter.  It's all the same."

;Charlie looked at his Grandpa and said, "I don't think those are the 
;same thing at all!"
...
;Hint #1:  Charlie does not know about truth tables, but you do.  So you 
;can determine the answer by hand.  This way you can test your code 
;which tests this property.  
...
;poor style.  Don't do it often; don't get carried away.
