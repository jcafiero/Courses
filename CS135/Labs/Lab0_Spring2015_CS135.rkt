...
;and then stopping. Just as the King of Hearts tells Alice in
;"Wonderland".
...
;Your TA will ask you to perform a simple calculation with a pair of
...
;Your TA will ask you something about a number's sign or parity.
...
;For your TA:  Use some simple predicates to silently explain the
...
;built-in functions in Scheme.  (They are, bu this is a "discrete" class
...
;And whisper to your TA what function "exp" represents in Scheme.


;GOLDEN TICKET

;Today's GOLDEN TICKET problem attempts to put this all together.
...
(define phi
  "your computation goes here") ;Don't forget the interior parentheses!
